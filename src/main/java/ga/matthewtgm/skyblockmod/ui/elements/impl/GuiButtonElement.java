...
public class GuiButtonElement extends AbstractGuiElement {
    ...
    public void render(int mouseX, int mouseY, float partialTicks) {
        ...
        RenderUtils.getInstance().drawRoundedRect(getX(), getY(), getWidth(), getHeight(), 4, backgroundColor);
        FontRendererUtils.getInstance().drawCenteredString(fontRenderer, getDisplay(), getX() + this.getWidth() / 2, this.getY() + (this.getHeight() - 8) / 2, textColor.getRGB());
    }
