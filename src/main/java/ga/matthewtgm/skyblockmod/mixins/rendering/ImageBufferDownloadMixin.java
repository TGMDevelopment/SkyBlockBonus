...
import ga.matthewtgm.skyblockmod.features.impl.other.FeatureSkinRenderingFix;
...
public abstract class ImageBufferDownloadMixin {
    ...
    public BufferedImage parseUserSkin(BufferedImage image)
    {
        ...
        {
            if (SkyBlockBonus.getInstance().getFeatureManager().getFeatureToggle(FeatureSkinRenderingFix.class))
            {
                this.imageWidth = 64;
                this.imageHeight = 64;
